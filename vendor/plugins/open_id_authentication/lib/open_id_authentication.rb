...
module OpenIdAuthentication
  ...
  private
    ...
    def open_id_redirect_url(open_id_request, return_to = nil, method = nil)
      ...
      # PATCH - https://rails.lighthouseapp.com/attachments/43873/forgery_protection_and_relative_url_root.patch
    ...
    def requested_url
      ...
      # LAST LINE PATCH - https://rails.lighthouseapp.com/attachments/43873/forgery_protection_and_relative_url_root.patch
    end
